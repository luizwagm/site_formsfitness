...
#      mkdir -p ~/bin && cp ci/entregar.sh ~/bin/entregar-forms
#      chmod 755 ~/bin/entregar-forms
#
#  E no ~/.ssh/authorized_keys, a chave da entrega entra assim:
#      restrict,command="/home/deploy/bin/entregar-forms" ssh-ed25519 AAAA... entrega-forms
#
...
PROJETO="/var/www/projetos/Forms-Fitness"
TRAVA="/tmp/entregar-forms.lock"
...
logger -t entrega-forms "pedido de entrega de ${SSH_CLIENT%% *}"
...
logger -t entrega-forms "entrega terminou com código $CODIGO"
exit $CODIGO
